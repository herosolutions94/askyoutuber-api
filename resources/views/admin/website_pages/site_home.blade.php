                            ...
                            <div class="col-span-12 xl:col-span-8">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="input w-full border mt-2" placeholder="Input text"
                                        value="{{ !empty($sitecontent) ? $sitecontent['section1_search_text'] : '' }}"
                                        name="section1_search_text">
                                </div>
                                <div class="mt-3">
                                    <label>Search Button Text</label>
                                    <input type="text" class="input w-full border mt-2"
                                        value="{{ !empty($sitecontent) ? $sitecontent['section1_btn_text'] : '' }}"
                                        name="section1_btn_text">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-12 gap-2 p-5">
                    <div class="col-span-12 xl:col-span-6">
                        <div>
                            ...
                            <input type="text" class="input w-full border mt-2" placeholder="Input text"
                                value="{{ !empty($sitecontent) && array_key_exists('section3_link_text', $sitecontent) ? $sitecontent['section3_link_text'] : '' }}"
                                name="section3_link_text">
                        </div>
                    </div>
                    <div class="col-span-12 xl:col-span-6">
                        <div class="mt-2">
                            <label>Link Page</label>
                            <select class="select2 w-full" name="section3_link_url">
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                <div class="box">
                                    ...
                                    <div class="p-5" id="simple-editor">
                                        ...
                                        <textarea data-feature="all" class="ckeditor" name="section5_step1">{{ !empty($sitecontent) ? $sitecontent['section5_step1'] : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 lg:col-span-4">
                                <div class="box">
                                    ...
                                    <div class="p-5" id="simple-editor">
                                        ...
                                        <textarea data-feature="all" class="ckeditor" name="section5_step2">{{ !empty($sitecontent) ? $sitecontent['section5_step2'] : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 lg:col-span-4">
                                        ...
                                        <div class="border border-gray-200 rounded-md p-5 change_thumbnail_image mb-5">
                                            ...
                                            <div class="w-40 mx-auto cursor-pointer relative mt-5">
                                                <button type="button" class="button w-full bg-theme-1 text-white">Change
                                                    Step 1 Image</button>
                                                <input type="file"
                                                    class="w-full h-full top-0 left-0 absolute opacity-0" name="image5">
                                            </div>
                                        </div>
                                        <textarea data-feature="all" class="ckeditor" name="section5_step3">{{ !empty($sitecontent) ? $sitecontent['section5_step3'] : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-5">
                            <div class="col-span-12 xl:col-span-4">
                                <div class="border border-gray-200 rounded-md p-5 change_thumbnail_image">
                                    <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                        <img class="rounded-md"
                                            alt="{{ !empty($sitecontent) ? $sitecontent['page_title'] : '' }}"
                                            src="{{ get_site_image_src('images', !empty($sitecontent) && array_key_exists('image6', $sitecontent) ? $sitecontent['image6'] : '') }}">
                                    </div>
                                    <div class="w-40 mx-auto cursor-pointer relative mt-5">
                                        <button type="button" class="button w-full bg-theme-1 text-white">Change
                                            Image </button>
                            ...
                            <div class="col-span-12 xl:col-span-8">
                                <div class="mt-3">
                                    <label>Text Block</label>
                                    <textarea data-feature="all" class="ckeditor" name="section6_detail">{{ !empty($sitecontent) ? $sitecontent['section6_detail'] : '' }}</textarea>
                                </div>
                                    ...
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                ...
                                                value="{{ !empty($sitecontent) && !empty($sitecontent['section6_sub_count']) ? $sitecontent['section6_sub_count'] : '' }}"
                                                name="section6_sub_count">
                                        </div>
                                    </div>
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                placeholder="Input text"
                                                value="{{ !empty($sitecontent) && !empty($sitecontent['section6_sub_count_text']) ? $sitecontent['section6_sub_count_text'] : '' }}"
                                                name="section6_sub_count_text">
                                        </div>
                                    </div>
                                </div>
                                <div class="grid grid-cols-12 gap-2">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                placeholder="Input text"
                                                value="{{ !empty($sitecontent) ? $sitecontent['section6_link_text'] : '' }}"
                                                name="section6_link_text">
                                        </div>
                                    </div>
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="mt-3">
                                            <label>Link 1 Page</label>
                                            <select class="select2 w-full" name="section6_link_url">
                                                @foreach ($all_pages as $key => $page)
                                                    <option value="{{ $key }}"
                                                        {{ !empty($sitecontent['section6_link_url']) && $sitecontent['section6_link_url'] == $key ? 'selected' : '' }}>
                                                        {{ $page }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-5">
                            <div class="col-span-12 xl:col-span-4">
                                <div class="border border-gray-200 rounded-md p-5 change_thumbnail_image">
                                    <div class="w-40 h-40 relative image-fit cursor-pointer zoom-in mx-auto">
                                        <img class="rounded-md"
                                            alt="{{ !empty($sitecontent) ? $sitecontent['page_title'] : '' }}"
                                            src="{{ get_site_image_src('images', !empty($sitecontent) && array_key_exists('image7', $sitecontent) ? $sitecontent['image7'] : '') }}">
                                    </div>
                                    <div class="w-40 mx-auto cursor-pointer relative mt-5">
                                        <button type="button" class="button w-full bg-theme-1 text-white">Change
                                            Image </button>
                            ...
                            <div class="col-span-12 xl:col-span-8">
                                <div class="mt-3">
                                    <label>Text Block</label>
                                    <textarea data-feature="all" class="ckeditor" name="section7_detail">{{ !empty($sitecontent) ? $sitecontent['section7_detail'] : '' }}</textarea>
                                </div>
                                <div class="grid grid-cols-12 gap-2">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                placeholder="Input text"
                                                value="{{ !empty($sitecontent) ? $sitecontent['section7_link_text'] : '' }}"
                                                name="section7_link_text">
                                        </div>
                                    </div>
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="mt-3">
                                            <label>Link 1 Page</label>
                                            <select class="select2 w-full" name="section7_link_url">
                                                @foreach ($all_pages as $key => $page)
                                                    <option value="{{ $key }}"
                                                        {{ !empty($sitecontent['section7_link_url']) && $sitecontent['section7_link_url'] == $key ? 'selected' : '' }}>
                                                        {{ $page }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="grid grid-cols-12 gap-2 mt-3">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                placeholder="Input text"
                                                value="{{ !empty($sitecontent) ? $sitecontent['section7_link_text1'] : '' }}"
                                                name="section7_link_text1">
                                        </div>
                                    </div>
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="mt-3">
                                            <label>Link 2 Page</label>
                                            <select class="select2 w-full" name="section7_link_url1">
                                                @foreach ($all_pages as $key => $page)
                                                    <option value="{{ $key }}"
                                                        {{ !empty($sitecontent['section7_link_url1']) && $sitecontent['section7_link_url1'] == $key ? 'selected' : '' }}>
                                                        {{ $page }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-12">
                        <div class="box">
                            <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                <h2 class="font-medium text-base mr-auto">
                                    Section 8 (What Our Clients Say About Us)
                                </h2>
                            </div>
                            <div class="p-5" id="simple-editor">
                                <textarea data-feature="all" class="ckeditor" name="section8_detail">{{ !empty($sitecontent) ? $sitecontent['section8_detail'] : '' }}</textarea>
                            </div>
