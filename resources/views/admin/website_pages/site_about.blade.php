                            ...
                            <div class="col-span-12 lg:col-span-12">
                                <div class="box">
                                    ...
                                    <div class="p-5" id="simple-editor">
                                        <textarea data-feature="all" class="ckeditor" name="section2_text">{{ !empty($sitecontent) ? $sitecontent['section2_text'] : '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- BEGIN: Simple Editor -->
                                ...
                                <div class="box">
                                    <div class="p-5" id="simple-editor">
                                        <input type="text" class="input w-full border mt-2"
                                            ...
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_number1'] : '' }}"
                                            name="section2_counter_number1">
                                        <input type="text" class="input w-full border mt-2"
                                            placeholder="Counter 1 Text"
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_text1'] : '' }}"
                                ...
                                <div class="box">
                                    <div class="p-5" id="simple-editor">
                                        <input type="text" class="input w-full border mt-2"
                                            ...
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_number2'] : '' }}"
                                            name="section2_counter_number2">
                                        <input type="text" class="input w-full border mt-2"
                                            placeholder="Counter 2 Text"
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_text2'] : '' }}"
                                ...
                                <div class="box">
                                    <div class="p-5" id="simple-editor">
                                        <input type="text" class="input w-full border mt-2"
                                            ...
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_number3'] : '' }}"
                                            name="section2_counter_number3">
                                        <input type="text" class="input w-full border mt-2"
                                            placeholder="Counter 3 Text"
                                            value="{{ !empty($sitecontent) ? $sitecontent['section2_counter_text3'] : '' }}"
                                    ...
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border mt-2"
                                                ...
                                                value="{{ !empty($sitecontent) ? $sitecontent['section3_link_text'] : '' }}"
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-12">
                        <div class="box">
                            <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                <h2 class="font-medium text-base mr-auto">
                                    Section 5 (What Our Clients Say About Us)
                                </h2>
                            </div>
                            <div class="p-5" id="simple-editor">
